...
try:
    ...
    # Fallback si aún no se ha re-entrenado el modelo
    print("ADVERTENCIA: SVM no tiene probabilidades activas. Por favor entrena de nuevo Modelos_SVM.py. Cayendo a decision_function pero el soft voting podría fallar o ser inexacto.")
    scores_svm = svm_model.decision_function(X_test)

# Soft voting
# Promediamos las probabilidades de los tres modelos
print("Ejecutando Soft Voting...")
mean_probs = (scores_xgb + scores_rf + scores_svm) / 3
# np.argmax devolverá 0, 1, o 2 que coincide con el mapeo alfabético original (0:AD, 1:MCI, 2:NL)
